        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    #getting the product variations using cart id
                    product_variation = []
                    for item in cart_item:
                        variation = item.variations.all()
                        product_variation.append(list(variation))
                        
                        #getting cart items from the user to access his product variation
    ...
    if request.method == 'POST':
        ...
        if new_password == confirm_password:
            ...
            if success:
                ...
                user.save()
                #auth.logout(request)----------> to logout after changing password 
